package com.iAnalyze.data.processing.BigDataProcessing.model;
...
public class TransactionRecord {
    ...
    public TransactionRecord(int step, String type, float amount, String nameOrig, float oldBalanceOrig,
    ...
    public String toString() {
        return String.format("Transaction Record[step='%d', type='%s', amount='%f', nameOrig='%s', oldBalanceOrg='%f'," +
                " newBalanceOrg='%f', nameDest='%s', oldBalanceDest='%f', newBalanceDest='%f', isFraud='%d', isFlaggedFraud='%d']"
